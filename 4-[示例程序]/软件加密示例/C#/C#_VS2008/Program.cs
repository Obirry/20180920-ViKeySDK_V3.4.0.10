...
namespace ViKeySample
{
    class Program
    {
        ...
        [DllImport("ViKey")]
        public static extern uint Vikey3DesSetKey(ushort Index, Byte[] pKey, ushort KeyType);
        [DllImport("ViKey")]
        ...
        static string ToHexString(byte[] bytes, int length) // byte[]转16进制格式string 0xae00cf => "AE00CF "
        {
        ...
        static void ViKeySample()
        {
            ...
            string strDesText = "12345678";
            Byte[] szDesResult = new Byte[256];
...
//                 buffer = System.Text.Encoding.Default.GetBytes(strDesText); // convert unicode to asccii
//                 retcode = Vikey3DesEncrypt(j, 8, buffer, szDesResult); 
//                 if (retcode != 0)
//                 {
//                     System.Console.WriteLine("Des失败 error code: ", retcode);
//                     return;
//                 }
// 
//                 string strDesResult = System.Text.Encoding.Default.GetString(szDesResult);
//                 System.Console.WriteLine("Des加密结果：" + ToHexString(szDesResult, 8));
