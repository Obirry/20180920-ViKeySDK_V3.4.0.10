...
#End Region
    ...
    Declare Function VikeyUserLogin Lib "ViKey.DLL" (ByVal Index As Integer, ByVal UserPassword As String) As Integer
    Declare Function VikeyAdminLogin Lib "ViKey.DLL" (ByVal Index As Integer, ByVal AdminPassword As String) As Integer
    Declare Function VikeyLogoff Lib "ViKey.DLL" (ByVal Index As Integer) As Integer
    Declare Function VikeyResetPassword Lib "ViKey.DLL" (ByVal Index As Integer, ByVal NewUserPassword As String, ByVal AdminUserPassword As String) As Integer

    Declare Function VikeySetUserPassWordAttempt Lib "ViKey.DLL" (ByVal Index As Integer, ByVal buffer As Byte) As Integer
    Declare Function VikeySetAdminPassWordAttempt Lib "ViKey.DLL" (ByVal Index As Integer, ByVal buffer As Byte) As Integer

    Declare Function VikeySetPtroductName Lib "ViKey.DLL" (ByVal Index As Integer, ByRef SoftID As Byte) As Integer
    Declare Function VikeyGetPtroductName Lib "ViKey.DLL" (ByVal Index As Integer, ByRef lpSoftID As Byte) As Integer


    Declare Function VikeySetSoftIDString Lib "ViKey.DLL" (ByVal Index As Integer, ByVal SoftID As String) As Integer
    Declare Function VikeyGetSoftIDString Lib "ViKey.DLL" (ByVal Index As Integer, ByVal lpSoftID As System.Text.StringBuilder) As Integer

    Declare Function VikeyReadData Lib "ViKey.DLL" (ByVal Index As Integer, ByVal Addr As Integer, ByVal Length As Integer, ByVal buffer As System.Text.StringBuilder) As Integer
    Declare Function VikeyWriteData Lib "ViKey.DLL" (ByVal Index As Integer, ByVal Addr As Integer, ByVal Length As Integer, ByVal buffer As String) As Integer
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim NewUserPassWord As String = "22222222"
        Dim NewAdminPassWord As String = "33333333"
        Dim PassWordAttempt As Byte

        Dim SetName() As Byte = System.Text.Encoding.Unicode.GetBytes("12345678")
        Dim GetName() As Byte = System.Text.Encoding.Unicode.GetBytes("0000000000000000")
        ...
        'admin logon ViKey
        '修改用户密码为22222222 管理员密码为33333333
'        NewUserPassWord = "22222222"
'        NewAdminPassWord = "33333333"
'        retcode = VikeyResetPassword(Index, NewUserPassWord, NewAdminPassWord)
'        If (retcode <> 0) Then
'            RichTextBox1.AppendText("修改加密狗密码错误:" & Hex(retcode) & Chr(13))
'            Exit Sub
'        End If
'        RichTextBox1.AppendText("修改加密狗密码成功: " & Chr(13))
'
'        PassWordAttempt = 89
'        retcode = VikeySetUserPassWordAttempt(Index, PassWordAttempt)
'        If (retcode <> 0) Then
'            RichTextBox1.AppendText("修改加密狗用户密码次数错误:" & Hex(retcode) & Chr(13))
'            Exit Sub
'        End If
'        RichTextBox1.AppendText("修改加密狗用户密码次数成功: " & Chr(13))
'
'        PassWordAttempt = 80
'        retcode = VikeySetAdminPassWordAttempt(Index, PassWordAttempt)
'        If (retcode <> 0) Then
'            RichTextBox1.AppendText("修改加密狗管理员密码次数错误:" & Hex(retcode) & Chr(13))
'            Exit Sub
'        End If
'        RichTextBox1.AppendText("修改加密狗管理员密码次数成功: " & Chr(13))

        'Set SoftID 


        retcode = VikeySetPtroductName(Index, SetName(0))
        If (retcode <> 0) Then
            RichTextBox1.AppendText("设置PtroductName错误:" & Hex(retcode) & Chr(13))
            Exit Sub
        End If
        Dim txt1 As String = System.Text.Encoding.Unicode.GetString(SetName)
        RichTextBox1.AppendText("设置PtroductName成功：" & txt1 & Chr(13))

        RetSoftIDBuffer.Length = 8
        retcode = VikeyGetPtroductName(Index, GetName(0))
        If (retcode <> 0) Then
            RichTextBox1.AppendText("获取PtroductName错误:" & Hex(retcode) & Chr(13))
            Exit Sub
        End If

        Dim txt2 As String = System.Text.Encoding.Unicode.GetString(GetName)
        RichTextBox1.AppendText("获取PtroductName成功:" & txt2 & Chr(13))
